  ...
  return (
    <main>
      ...
      <header className="mb-8">
        <p className="text-xs font-semibold text-sky-600">Privacy Policy</p>
        <h1 className="mt-1 text-2xl font-bold md:text-3xl">プライバシーポリシー</h1>
      </header>
      ...
      <section className="space-y-8">
        <article>
          <h2 className="mb-2 text-lg font-semibold">第1条（個人情報）</h2>
        ...
        <article>
          <h2 className="mb-2 text-lg font-semibold">第2条（個人情報の収集方法）</h2>
          <p className="leading-7 text-gray-700">
            当社は，ユーザーが本サービスにおけるフォームへの入力をされる際、又は、その他本サービスに関連して適正な方法により、
            氏名，生年月日，住所，電話番号，メールアドレスその他ユーザーに関する個人情報などを収集いたします。
            また，本サービスに関連して，ユーザーと当社の提携先（情報提供元，広告主，広告配信先などを含みます。以下，｢提携先｣といいます。）などとの間でなされた
            ユーザーの個人情報を含む取引記録や決済に関する情報を，提携先などから収集することがあります。
          </p>
        </article>

        <article>
          <h2 className="mb-2 text-lg font-semibold">第3条（個人情報を収集・利用する目的）</h2>
        ...
        <article>
          <h2 className="mb-2 text-lg font-semibold">第4条（利用目的の変更）</h2>
          <p className="leading-7 text-gray-700">
            当社は，利用目的が変更前と関連性を有すると合理的に認められる場合に限り，個人情報の利用目的を変更するものとします。
            利用目的の変更を行った場合には，変更後の目的について，第９条記載の所定の方法により，本ウェブサイト上に公表するものとします。
          </p>
        </article>

        <article>
          <h2 className="mb-2 text-lg font-semibold">第5条（個人情報の第三者提供）</h2>
          <ol className="list-decimal space-y-2 pl-6 text-gray-700">
            <li>
              当社は，次に掲げる場合を除いて，あらかじめユーザーの同意を得ることなく，第三者に個人情報を提供することはありません。
              ただし，個人情報保護法その他の法令で認められる場合を除きます。
              <ol className="list-[kana] mt-2 space-y-2 pl-6">
        ...
        <article>
          <h2 className="mb-2 text-lg font-semibold">第6条（個人情報の開示）</h2>
          <p className="leading-7 text-gray-700">
        ...
        <article>
          <h2 className="mb-2 text-lg font-semibold">第7条（個人情報の訂正および削除）</h2>
          <ol className="list-decimal space-y-2 pl-6 text-gray-700">
            <li>
              ユーザーは，当社の保有する自己の個人情報が誤った情報である場合には，当社が定める手続きにより，
              書面によって当社に対して個人情報の訂正，追加または削除（以下，「訂正等」といいます。）を請求することができます。
            </li>
            <li>
        ...
        <article>
          <h2 className="mb-2 text-lg font-semibold">第9条（プライバシーポリシーの変更）</h2>
          <p className="leading-7 text-gray-700">
        ...
        <article>
          <h2 className="mb-2 text-lg font-semibold">第10条（お問い合わせ窓口）</h2>
          <p className="leading-7 text-gray-700">
            開示，訂正，利用停止等本ポリシーに関するお問い合わせは，下記の窓口までお願いいたします。具体的な方法については，個別にご案内いたします。
          </p>

          <div className="mt-4 rounded-lg border border-gray-200 bg-white p-4 leading-7 text-gray-800">
            <div>住所：東京都新宿区西新宿7−22−39-703</div>
            <div>社名：Jbbc.com</div>
            <div>
              Eメールアドレス：
              <a href="mailto:info@jbbc.com" className="text-sky-600 underline">
                info@jbbc.com
              </a>
            </div>
          </div>
