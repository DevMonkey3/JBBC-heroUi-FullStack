...
export const SSW = (props: any) => {
  // NEW: control mobile menu so we can close it after click

  return (
     <div className="container mx- auto px - 4 py - 8">
        < div className = "text-center mb-4" >
        {/* <h1 className="text-2xl font-bold text-gray-800">高度専門職制度について</h1> */}
      </div >
        <div className="text-justify leading-relaxed text-gray-700">
            <p className="mb-2">
                高度専門職制度は、<strong>ポイント制</strong>を採用しており、学歴・職歴・年収・年齢・日本語能力などに応じてポイントが加算され、<strong>合計70点以上</strong>で申請が可能です。
            </p>
            <p className="mb-2">
                主な対象分野は以下のとおりです：
            </p>
            ...
            <p className="mb-2">
                高度な資格や専門性を持つバングラデシュの人材にとって、日本でキャリアを築く大きなチャンスとなっています。
            </p>
        </div>
    </div >
  );
...
export const TITP=(props:any)=>{
    return (
   <div className="container mx-auto px-4 py-2">
      {/* <div className="text-center mb-4">
        <h1 className="text-2xl font-bold text-gray-800">プログラム概要</h1>
      </div> */}
...
export const Overseas=(props:any)=>{
    return (
   <div className="container mx-auto px-4 py-2">
      {/* <div className="text-center mb-4">
        <h1 className="text-2xl font-bold text-gray-800">プログラム概要</h1>
